...
const translations: Record<Lang, Translations> = {
  ...
  rn: {
    ...
    games: "Imikino",
    categories: "Ibice",
    welcomeTo: "Murakaza neza kuri Play365Game",
    experienceUltimate: "Meny<b>a</b> urubuga <br /> rw'imiki<b>n</b>o rwiza",
    whereEvery: "Aho umukino wose ari urugendo rutungereje gufatwa",
    instantAccess: "Play365Game ikugenera uburyo bwo gukina ako kanya imikino amajana mu bice vyose.",
    exploreCategories: "Raba Ibice vy'Imikino",
    exploreDesc: "Injira mu mikino yacu itandukanye. Kuva ku mikino y'igikorwa kugeza ku mikino y'ubwenge.",
    actionTitle: "Igik<b>o</b>rwa",
    puzzleTitle: "Ubwe<b>n</b>ge",
    top10Title: "Imikino <b>1</b>0 Nziza",
    arcadeTitle: "Arca<b>d</b>e",
    action: "Menya imikino y'igikorwa irimo intambara zikomeye n'amahiganwa menshi.",
    puzzle: "Gerageza ubwenge bwawe n'imikino y'ubwenge n'ugushira mu giti.",
    top10: "Menya imikino yacu ikundwa cane n'abakinyi bo mw'isi yose.",
    arcade: "Fata umunezero w'imikino ya kera n'imikino ya arcade.",
    moreGames: "Imiki<b>n</b>o mi<b>n</b>shi",
    journeyStarts: "urugendo rwawe rw'imikino rutangura ngaha",
    discoverEndless: "me<b>n</b>ya <br /> imiki<b>n</b>o idashira",
    jumpInto: "Injira mu gukina gushimishije n'uburyo bwo gukina ako kanya imikino nziza cane.",
    joinCommunity: "Injira mu Muryango Wacu",
    letsPlay: "tukin<b>e</b> kandi <br /> tusi<b>n</b>ze <br /> hamw<b>e</b>.",
    playAnytime: "Kina Igihe Cose, Hose",
    gamingHub: "Ikigo cawe c'Imikino Kiragutegereje",
    gameCategories: "Ib<b>i</b>ce vy'Imikino",
    allGames: "Imikino Yose",
    top10Games: "Imikino 10 Nziza",
    easyToPlay: "Yoroshye Gukina",
    playBtn: "Kina",
    back: "Subira",
    playConquer: "Kina & Sinza",
    exploreEpic: "Rab<b>a</b> Imikino <br /> Nsh<b>i</b>mishije",
    thrilling: "Injira mu mikino yacu y'urugendo rushimishije",
  ...
  lo: {
    ...
    games: "ເກມ",
    categories: "ໝວດໝູ່",
    welcomeTo: "ຍິນດີຕ້ອນຮັບສູ່ Play365Game",
    experienceUltimate: "ສໍາຜັດແພລດຟອຣ<b>ມ</b> <br /> ເກມທີ່ດີທີ່ສຸດ",
    whereEvery: "ບ່ອນທີ່ທຸກເກມເປັນການຜະຈົນໄພທີ່ລໍຖ້າການພິຊິດ",
    instantAccess: "Play365Game ໃຫ້ທ່ານເຂົ້າເຖິງເກມຫຼາຍຮ້ອຍເກມໃນທຸກໝວດໝູ່ໄດ້ທັນທີ.",
    exploreCategories: "ສຳຫຼວດໝວດໝູ່ເກມ",
    exploreDesc: "ເຂົ້າສູ່ຄັງເກມທີ່ຫຼາກຫຼາຍຂອງພວກເຮົາ. ຈາກເກມປະເພດຄວາມຕື່ນເຕັ້ນໄປຈົນເຖິງປັຊເຊິນ.",
    actionTitle: "ຄວາມຕື່ນເຕັ້ນ",
    puzzleTitle: "ປັຊເຊິນ",
    top10Title: "ເກມທອບ <b>1</b>0",
    arcadeTitle: "ອາເຄດ",
    action: "ປະສົບການເກມຄວາມຕື່ນເຕັ້ນກັບການສູ້ຮົບທີ່ຮຸນແຮງ ແລະ ສູ້ຮົບຍິ່ງໃຫຍ່.",
    puzzle: "ທ້າທາຍສະໝອງຂອງທ່ານດ້ວຍປັຊເຊິນ ແລະ ການຄິດຍຸດທະສາດ.",
    top10: "ຄົ້ນພົບເກມທີ່ນິຍົມທີ່ສຸດຂອງພວກເຮົາທີ່ຜູ້ຫຼິ້ນທົ່ວໂລກຊອບ.",
    arcade: "ເພີດເພີນກັບເກມອາເຄດແບບຄລາສສິກກັບເກມແບບຍ້ອນຍຸກ.",
    moreGames: "ເກມເພີ່ມເຕີມ",
    journeyStarts: "ການເດີນທາງເກມຂອງທ່ານເລີ່ມທີ່ນີ້",
    discoverEndless: "ຄົ້ນພົບ <br /> ເກມໄມ່ມີທີ່ສິ້ນສຸດ",
    jumpInto: "ເຂົ້າສູ່ການຫຼິ້ນທີ່ຕື່ນເຕັ້ນພ້ອມການເຂົ້າເຖິງເກມຄະແນນສູງໄດ້ທັນທີ.",
    joinCommunity: "ເຂົ້າຮ່ວມຊຸມຊົນຂອງພວກເຮົາ",
    letsPlay: "ມາຫຼິ້ນ ແລະ <br /> ພິຊິດ <br /> ຮ່ວມກັນ.",
    playAnytime: "ຫຼິ້ນໄດ້ທຸກເວລາ ທຸກບ່ອນ",
    gamingHub: "ສູນເກມຂອງທ່ານລໍຖ້າຢູ່",
    gameCategories: "ໝວດໝູ່ເກມ",
    allGames: "ເກມທັງໝົດ",
    top10Games: "ເກມທອບ 10",
    easyToPlay: "ຫຼິ້ນງ່າຍ",
    playBtn: "ຫຼິ້ນ",
    back: "ກັບຄືນ",
    playConquer: "ຫຼິ້ນ & ພິຊິດ",
    exploreEpic: "ສຳຫຼວດເກມ <br /> ຍິ່ງໃຫຍ່",
    thrilling: "ເຂົ້າສູ່ຄັງການຜະຈົນໄພທີ່ຕື່ນເຕັ້ນ",
  ...
  sw: {
    ...
    welcomeTo: "Karibu kwenye Play365Game",
    experienceUltimate: "Pata uzo<b>e</b>fu wa jukwaa <br /> bora la michezo",
    whereEvery: "Ambapo kila mchezo ni adventure inayosubiri kushindwa",
    instantAccess: "Play365Game inakupa ufikiaji wa papo hapo wa mamia ya michezo katika kategoria zote.",
    exploreCategories: "Chunguza Kategoria za Michezo",
    exploreDesc: "Ingia katika mkusanyiko wetu wa michezo mbalimbali. Kutoka kwa hatua kali hadi mafumbo ya kupumzika.",
    actionTitle: "Hatua",
    puzzleTitle: "Fumbo",
    top10Title: "Michezo <b>1</b>0 Bora",
    arcadeTitle: "Arkeidi",
    action: "Pata michezo ya hatua yenye mapigano makali na vita vikubwa.",
    puzzle: "Changamoto akili yako na mafumbo na fikra za kimkakati.",
    top10: "Gundua michezo yetu maarufu zaidi inayopendwa na wachezaji duniani kote.",
    arcade: "Furahia burudani ya arkeidi ya kitamaduni na michezo ya zamani.",
    moreGames: "Michezo <b>z</b>aidi",
    journeyStarts: "safari yako ya michezo inaanza hapa",
    discoverEndless: "gun<b>d</b>ua <br /> michezo isi<b>y</b>oisha",
    jumpInto: "Ingia katika uchezaji wa kusisimua na ufikiaji wa papo hapo wa michezo bora.",
    joinCommunity: "Jiunge na Jumuiya Yetu",
    letsPlay: "tucheze na <br /> tushi<b>n</b>de <br /> pamoj<b>a</b>.",
    playAnytime: "Cheza Wakati Wowote, Mahali Popote",
    gamingHub: "Kituo Chako cha Michezo Kinakungoja",
    gameCategories: "Kategoria za Michezo",
    allGames: "Michezo Yote",
    top10Games: "Michezo 10 Bora",
    easyToPlay: "Rahisi Kucheza",
    playBtn: "Cheza",
    back: "Rudi",
    playConquer: "Cheza & Shinda",
    exploreEpic: "Chunguza Michezo <br /> ya Kuvutia",
    thrilling: "Ingia katika mkusanyiko wetu wa adventures za kusisimua",
